# ==================== LESSON 15 START ====================
# ILO: Train a machine learning model using Naive Bayes
...
# ==================== LESSON 16 START ====================
# ILO: Predict disease from user input text
...
def predict_disease():
    ...
    # ==================== LESSON 17 START ====================
    # ILO: Display prediction confidence with visual indicators
...
root.title("🧠 AI Doctor - Disease Predictor using Naive Bayes")  # setting the title
root.geometry("600x500")    # setting the size of the canvas
